  ...
  -- Add tables to realtime publication for live websocket changes
  DO $$
  BEGIN
    IF EXISTS (SELECT 1 FROM pg_publication WHERE pubname = 'supabase_realtime') THEN
      ALTER PUBLICATION supabase_realtime ADD TABLE organizations;
      ALTER PUBLICATION supabase_realtime ADD TABLE platform_subscriptions;
      ALTER PUBLICATION supabase_realtime ADD TABLE platform_invoices;
      ALTER PUBLICATION supabase_realtime ADD TABLE platform_incidents;
      ALTER PUBLICATION supabase_realtime ADD TABLE platform_background_jobs;
      ALTER PUBLICATION supabase_realtime ADD TABLE platform_audit_events;
    END IF;
  EXCEPTION
  ...
  ALTER TABLE platform_usage_snapshots ENABLE ROW LEVEL SECURITY;
  ...
  ALTER TABLE platform_background_jobs ENABLE ROW LEVEL SECURITY;
  ALTER TABLE platform_webhook_endpoints ENABLE ROW LEVEL SECURITY;
  ...
  -- Read-all for authenticated platform admins
  CREATE POLICY "Platform admins full access plans" ON platform_plans FOR ALL USING (true);
  CREATE POLICY "Platform admins full access subscriptions" ON platform_subscriptions FOR ALL USING (true);
  CREATE POLICY "Platform admins full access invoices" ON platform_invoices FOR ALL USING (true);
  CREATE POLICY "Platform admins full access incidents" ON platform_incidents FOR ALL USING (true);
  CREATE POLICY "Platform admins full access jobs" ON platform_background_jobs FOR ALL USING (true);
  CREATE POLICY "Platform admins full access audit" ON platform_audit_events FOR ALL USING (true);
  CREATE POLICY "Platform admins full access api_keys" ON platform_api_keys FOR ALL USING (true);
